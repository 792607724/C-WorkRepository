...
namespace SwitchResolutionTest
{
    public partial class TestForm : Form
    {
        ...
        private static readonly int TARGET_HID_HONGHE0103_VID = 0x2757;
        private static readonly int TARGET_HID_HONGHE0103_PID = 0x3008;
        ...
        private void TestBtn_Click(object sender, EventArgs e)
        {
            ...
            if (!m_IsRunning)
            {
                ...
                this.label2.Text = string.Format("重启：第{0}次", m_rebootCount);
                m_rebootCount = 0;
                m_previewCount = 0;
            }
            else
                ...
                if (m_ActionType == 0)
                {
                    ...
                    try
                    {
                        ...
                        if (!m_VideoCapturers[m_CameraIndex].StartupCapture(m_Cameras[m_CameraIndex], m_CameraIndex))
                        {
                            ...
                            string Text = string.Format("第{0}次重启Camera：第{0}次切换，{1} open error!",m_rebootCount, m_previewCount, previewSize.toString());
        ...
        private HIDDevice OpenHIDDevice()
        {
            ...
            else
            {
                ...
                MessageBox.Show("设备未找到！ 第"+ m_rebootCount+"重启");
            }
            return null;
        }
        ...
        private void reboot()
        {
            ...
            if (device != null)
            {
                ...
                Array.Copy(COMMAND_REQUEST_TYPE_AUTO_REBOOT, requestBuffer, COMMAND_REQUEST_TYPE_AUTO_REBOOT.Length);
