...
namespace SwitchResolutionTest
{
    public partial class TestForm : Form
    {
        ...
        private static readonly int SWITCH_INTERVAL_FIXED_0 = 2000;
        private static readonly int SWITCH_INTERVAL_FIXED_1 = 5000;
        private static readonly int SWITCH_INTERVAL_FIXED_2 = 1000;
        private static readonly int SWITCH_INTERVAL_MS_DEFAULT = 2000;
        ...
        private int[] m_SwitchInterval = { SWITCH_INTERVAL_FIXED_0, SWITCH_INTERVAL_FIXED_1, SWITCH_INTERVAL_FIXED_2 };
        ...
        private void TestBtn_Click(object sender, EventArgs e)
        {
            if (!m_IsRunning)
            {
                ...
                m_SwitchIntervalMode = this.comboBoxSwitchInterval.SelectedIndex != 3 ? SwitchIntervalMode.Fixed : SwitchIntervalMode.Random;
                m_SwitchMode = this.comboBoxSwitchMode.SelectedIndex == 0 ? SwitchMode.Sequential : SwitchMode.Random;

                this.timer1.Interval = m_SwitchIntervalMode == SwitchIntervalMode.Random ? m_Random.Next(SWITCH_INTERVAL_MS_MIN, SWITCH_INTERVAL_MS_MAX) : m_SwitchInterval[this.comboBoxSwitchInterval.SelectedIndex];
        ...
        private void checkedListBoxPreviewSizes_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void comboBoxSwitchMode_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void comboBoxSwitchInterval_SelectedIndexChanged(object sender, EventArgs e)
        {
