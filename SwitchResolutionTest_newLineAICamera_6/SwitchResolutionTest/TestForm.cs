...
// private static readonly string TARGET_CAMERA = "Smart Camera";
        private static readonly string[] TARGET_CAMERA = { "Smart Camera", "newline AI Camera(TC)", "AI Camera", "lifeme Smart Camera Pro"};
        ...
        private void selectDefaultPreviewSizes()
        {
            ...
            this.checkedListBoxPreviewSizes.SetItemChecked(indexOfPreviewSize(720, 1280), true);
            this.checkedListBoxPreviewSizes.SetItemChecked(indexOfPreviewSize(1080, 1920), true);
        }
